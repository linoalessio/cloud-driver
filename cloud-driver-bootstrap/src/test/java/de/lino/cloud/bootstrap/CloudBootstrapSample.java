...
public final class CloudBootstrapSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // DefaultFileFactory (returned by getFileFactory()) defers an upload into its
        // own PendingUploadCache instead of failing it when CloudAPI#getConnectivityChecker()
        // reports no connectivity - a real concern for any network-reached database, even
        // though this sample itself points at a local JSON file. A PendingUploadScheduler
        // retries everything queued there once connectivity returns, checked every 30
        // seconds. It retries via DataFactory directly rather than through the FileFactory
