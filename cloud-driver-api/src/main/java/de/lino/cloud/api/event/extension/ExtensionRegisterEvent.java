...
public class ExtensionRegisterEvent extends Event {
    ...
    public void handle(@NonNull JsonDocument properties) {
        ...
        this.cloudDriver().getTerminal().displayApproved(String.format("&7Extension '&b%s&7' (v%s) successfully &aloaded&7.", extensionProperties.getExtensionName(), extensionProperties.getExtensionVersion()));
