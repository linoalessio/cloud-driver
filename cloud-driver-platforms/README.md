...
- **[`cloud-driver-platforms-desktop`](cloud-driver-platforms-desktop/README.md)** — a JavaFX desktop client built on top of `cloud-driver-platforms-rest`.
...
mvn -pl cloud-driver-platform/cloud-driver-platform-rest,cloud-driver-platform/cloud-driver-platform-desktop -am install

# Run the desktop desktop directly
mvn -pl cloud-driver-platform/cloud-driver-platform-desktop -am org.openjfx:javafx-maven-plugin:0.0.8:run
```
