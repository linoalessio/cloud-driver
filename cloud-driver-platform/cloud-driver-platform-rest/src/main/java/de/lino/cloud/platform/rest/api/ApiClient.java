 ...
 * cloud-driver-platform-app}), not the calling thread itself. Both forms share one {@link
 ...
 * cloud-driver-platform-app}'s Caddyfile bullet), falling back to HTTP/1.1 automatically via ALPN
